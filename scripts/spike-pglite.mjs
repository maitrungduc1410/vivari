...
if (!process.env.VV_BIND_TIMEOUT) process.env.VV_BIND_TIMEOUT = "300000";
...
async function main() {
  ...
  await db.exec("INSERT INTO todos (task, done) VALUES ('Try Vivari', true), ('Run Postgres in the browser', false);");
