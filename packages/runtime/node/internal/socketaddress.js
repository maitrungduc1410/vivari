// DERIVED from Node.js — lib/internal/socketaddress.js
// Upstream: https://github.com/nodejs/node/blob/v24.18.0/lib/internal/socketaddress.js
// PROVENANCE (honest): as internal/blocklist.js — the v22.23.2 builtin source read out
// of a local Node via process.binding('natives'), because this sandbox has no network.
//
// VERBATIM. Its native half is internalBinding('block_list') too.
