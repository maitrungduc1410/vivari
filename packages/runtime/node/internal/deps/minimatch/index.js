// VENDORED from Node.js — lib/internal/deps/minimatch/index.js
// Source: https://github.com/nodejs/node/blob/v24.18.0/deps/minimatch (bundled by
// Node's own build into the builtin id `internal/deps/minimatch/index`).
...
// Licenses: minimatch (ISC), balanced-match (MIT), brace-expansion (MIT) — all
// bundled into this single esbuild CJS file by Node upstream; not re-bundled here.
// Required (lazily) by internal/fs/glob for fs.glob / fs.globSync / path.matchesGlob.
// Wrapped as a builtin factory. Do not edit the body.
