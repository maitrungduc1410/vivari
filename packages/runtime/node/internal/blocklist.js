// DERIVED from Node.js — lib/internal/blocklist.js
// Upstream: https://github.com/nodejs/node/blob/v24.18.0/lib/internal/blocklist.js
// PROVENANCE (honest): the repo pins v24.18.0, but this sandbox has no network. The
// body is the v22.23.2 builtin source, read out of a local Node via
// process.binding('natives').
//
// VERBATIM — the native half it drives is internalBinding('block_list'), which is
// bindings/block-list.js here. Gated by scripts/spike-net-blocklist.mjs against real
// Node, rule for rule and answer for answer.
