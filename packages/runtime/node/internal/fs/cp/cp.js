// VENDORED from Node.js — lib/internal/fs/cp/cp.js
...
// Interface check: our vendored v24 lib/fs.js uses { cpFn } (promise-returning,
// callbackified by fs.cp). It runs on the repo's pragmatic 'fs/promises'.
