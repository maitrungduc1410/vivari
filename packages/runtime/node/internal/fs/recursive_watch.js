// VENDORED from Node.js — lib/internal/fs/recursive_watch.js
...
// Backs fs.watch(path, { recursive: true }): on linux our vendored v24 lib/fs.js
// always routes recursive watches to this JS watcher (the native branch is macOS/
// Windows only). Deps — events, internal/{assert,errors,fs/utils,fs/watchers,util,
// validators}, path — are all already registered.
