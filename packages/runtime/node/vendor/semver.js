...
//
// Regenerate:
//   npm pack semver@7 && tar xzf semver-*.tgz
//   npx esbuild package/index.js --bundle --format=cjs --platform=neutral \
//     --legal-comments=none --outfile=semver.bundle.cjs
...
var require_constants = __commonJS({
  "package/internal/constants.js"(exports2, module2) {
    "use strict";
...
var require_debug = __commonJS({
  "package/internal/debug.js"(exports2, module2) {
    "use strict";
...
var require_re = __commonJS({
  "package/internal/re.js"(exports2, module2) {
    "use strict";
    var {
      MAX_SAFE_COMPONENT_LENGTH,
      MAX_SAFE_BUILD_LENGTH,
...
var require_parse_options = __commonJS({
  "package/internal/parse-options.js"(exports2, module2) {
    "use strict";
...
var require_identifiers = __commonJS({
  "package/internal/identifiers.js"(exports2, module2) {
    "use strict";
    var numeric = /^[0-9]+$/;
...
var require_semver = __commonJS({
  "package/classes/semver.js"(exports2, module2) {
    "use strict";
    var debug = require_debug();
...
var require_parse = __commonJS({
  "package/functions/parse.js"(exports2, module2) {
    "use strict";
...
var require_valid = __commonJS({
  "package/functions/valid.js"(exports2, module2) {
    "use strict";
...
var require_clean = __commonJS({
  "package/functions/clean.js"(exports2, module2) {
    "use strict";
    var parse2 = require_parse();
...
var require_inc = __commonJS({
  "package/functions/inc.js"(exports2, module2) {
    "use strict";
    var SemVer2 = require_semver();
...
var require_diff = __commonJS({
  "package/functions/diff.js"(exports2, module2) {
    "use strict";
    var parse2 = require_parse();
...
var require_major = __commonJS({
  "package/functions/major.js"(exports2, module2) {
    "use strict";
    var SemVer2 = require_semver();
...
var require_minor = __commonJS({
  "package/functions/minor.js"(exports2, module2) {
    "use strict";
    var SemVer2 = require_semver();
...
var require_patch = __commonJS({
  "package/functions/patch.js"(exports2, module2) {
    "use strict";
    var SemVer2 = require_semver();
    var patch2 = (a, loose) => new SemVer2(a, loose).patch;
...
var require_prerelease = __commonJS({
  "package/functions/prerelease.js"(exports2, module2) {
    "use strict";
    var parse2 = require_parse();
...
var require_compare = __commonJS({
  "package/functions/compare.js"(exports2, module2) {
    "use strict";
    var SemVer2 = require_semver();
...
var require_rcompare = __commonJS({
  "package/functions/rcompare.js"(exports2, module2) {
    "use strict";
...
var require_compare_loose = __commonJS({
  "package/functions/compare-loose.js"(exports2, module2) {
    "use strict";
    var compare2 = require_compare();
    var compareLoose2 = (a, b) => compare2(a, b, true);
    module2.exports = compareLoose2;
  }
});

// package/functions/compare-build.js
var require_compare_build = __commonJS({
  "package/functions/compare-build.js"(exports2, module2) {
    "use strict";
    var SemVer2 = require_semver();
    var compareBuild2 = (a, b, loose) => {
      const versionA = new SemVer2(a, loose);
      const versionB = new SemVer2(b, loose);
      return versionA.compare(versionB) || versionA.compareBuild(versionB);
    };
    module2.exports = compareBuild2;
  }
});

// package/functions/sort.js
var require_sort = __commonJS({
  "package/functions/sort.js"(exports2, module2) {
    "use strict";
    var compareBuild2 = require_compare_build();
    var sort2 = (list, loose) => list.sort((a, b) => compareBuild2(a, b, loose));
...
var require_rsort = __commonJS({
  "package/functions/rsort.js"(exports2, module2) {
    "use strict";
    var compareBuild2 = require_compare_build();
    var rsort2 = (list, loose) => list.sort((a, b) => compareBuild2(b, a, loose));
...
var require_gt = __commonJS({
  "package/functions/gt.js"(exports2, module2) {
    "use strict";
    var compare2 = require_compare();
...
var require_lt = __commonJS({
  "package/functions/lt.js"(exports2, module2) {
    "use strict";
    var compare2 = require_compare();
...
var require_eq = __commonJS({
  "package/functions/eq.js"(exports2, module2) {
    "use strict";
    var compare2 = require_compare();
...
var require_neq = __commonJS({
  "package/functions/neq.js"(exports2, module2) {
    "use strict";
    var compare2 = require_compare();
    var neq2 = (a, b, loose) => compare2(a, b, loose) !== 0;
...
var require_gte = __commonJS({
  "package/functions/gte.js"(exports2, module2) {
    "use strict";
    var compare2 = require_compare();
...
var require_lte = __commonJS({
  "package/functions/lte.js"(exports2, module2) {
    "use strict";
    var compare2 = require_compare();
...
var require_cmp = __commonJS({
  "package/functions/cmp.js"(exports2, module2) {
    "use strict";
    var eq2 = require_eq();
    ...
    module2.exports = cmp2;
  }
});

// package/functions/coerce.js
var require_coerce = __commonJS({
  "package/functions/coerce.js"(exports2, module2) {
    "use strict";
    var SemVer2 = require_semver();
    var parse2 = require_parse();
    var { safeRe: re, t } = require_re();
...
var require_truncate = __commonJS({
  "package/functions/truncate.js"(exports2, module2) {
    "use strict";
    var parse2 = require_parse();
    ...
    var cloneInputVersion = (version, options) => {
      const versionStringToParse = version instanceof SemVer2 ? version.version : version;
...
var require_lrucache = __commonJS({
  "package/internal/lrucache.js"(exports2, module2) {
    "use strict";
    var LRUCache = class {
      constructor() {
        this.max = 1e3;
...
var require_range = __commonJS({
  "package/classes/range.js"(exports2, module2) {
    "use strict";
...
var require_comparator = __commonJS({
  "package/classes/comparator.js"(exports2, module2) {
    "use strict";
...
var require_satisfies = __commonJS({
  "package/functions/satisfies.js"(exports2, module2) {
    "use strict";
    var Range2 = require_range();
...
var require_to_comparators = __commonJS({
  "package/ranges/to-comparators.js"(exports2, module2) {
    "use strict";
    var Range2 = require_range();
    var toComparators2 = (range, options) => new Range2(range, options).set.map((comp) => comp.map((c) => c.value).join(" ").trim().split(" "));
    module2.exports = toComparators2;
  }
});

// package/ranges/max-satisfying.js
var require_max_satisfying = __commonJS({
  "package/ranges/max-satisfying.js"(exports2, module2) {
    "use strict";
    var SemVer2 = require_semver();
    var Range2 = require_range();
...
var require_min_satisfying = __commonJS({
  "package/ranges/min-satisfying.js"(exports2, module2) {
    "use strict";
    var SemVer2 = require_semver();
    var Range2 = require_range();
    var minSatisfying2 = (versions, range, options) => {
      let min = null;
      let minSV = null;
      let rangeObj = null;
      try {
...
var require_min_version = __commonJS({
  "package/ranges/min-version.js"(exports2, module2) {
    "use strict";
    var SemVer2 = require_semver();
    var Range2 = require_range();
    var gt2 = require_gt();
...
var require_valid2 = __commonJS({
  "package/ranges/valid.js"(exports2, module2) {
    "use strict";
    var Range2 = require_range();
...
var require_outside = __commonJS({
  "package/ranges/outside.js"(exports2, module2) {
    "use strict";
    var SemVer2 = require_semver();
    var Comparator2 = require_comparator();
    var { ANY } = Comparator2;
    ...
    module2.exports = outside2;
  }
});

// package/ranges/gtr.js
var require_gtr = __commonJS({
  "package/ranges/gtr.js"(exports2, module2) {
    "use strict";
    var outside2 = require_outside();
    var gtr2 = (version, range, options) => outside2(version, range, ">", options);
...
var require_ltr = __commonJS({
  "package/ranges/ltr.js"(exports2, module2) {
    "use strict";
    var outside2 = require_outside();
    var ltr2 = (version, range, options) => outside2(version, range, "<", options);
    module2.exports = ltr2;
  }
});

// package/ranges/intersects.js
var require_intersects = __commonJS({
  "package/ranges/intersects.js"(exports2, module2) {
    "use strict";
    var Range2 = require_range();
    ...
    module2.exports = intersects2;
  }
});

// package/ranges/simplify.js
var require_simplify = __commonJS({
  "package/ranges/simplify.js"(exports2, module2) {
    "use strict";
    var satisfies2 = require_satisfies();
    var compare2 = require_compare();
...
var require_subset = __commonJS({
  "package/ranges/subset.js"(exports2, module2) {
    "use strict";
    var Range2 = require_range();
    var Comparator2 = require_comparator();
    var { ANY } = Comparator2;
