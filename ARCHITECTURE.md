...
└───────────────┬────────────────────────────────────────────────────────┘
                ...
                ▼
┌──────────────────────────────────────────────────────────────────────┐
│ Kernel Worker — packages/core/src/workers/kernel-worker.js                         │
...
│ Worker      │   │ Worker        │   │  packages/core/src/workers/process-worker.js│
...
- **Servicing**: `packages/kernel-host/fs-server.js` (`FsServer`) owns the one VFS
  ...
  the **File System Worker** (`packages/core/src/workers/fs-worker.js`).
...
worker** (`packages/core/src/workers/kernel-worker.js`) because that worker is the sole holder of the synchronous
...
- **Registry aliasing** (`packages/core/src/workers/fetcher-worker.js`): when npm requests the
